...
public class CatalogClient {
	...
	public CatalogClient(
		...
		System.out.println( "**** catalog service host " + catalogServiceHost + " port " + catalogServicePort);
	}
	...
	public Collection<Item> findAll() {
		System.out.println("**** in the find all orders ");
	...
	private String catalogURL() {
		...
		System.out.println ("**** in the catalog url method " + url );
		return url;
	}
