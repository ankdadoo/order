...
public class CustomerClient {
	...
	public CustomerClient(@Value("${customer.service.host:customer}") String customerServiceHost,
		...
		System.out.println("**** customer service host " + customerServiceHost + "  port " + customerServicePort);
		System.out.println("**** ribbon flag " + useRibbon);
	}
	...
	private String customerURL() {
		...
		if (useRibbon) {
			...
			url = "http://" + instance.getHost() + ":" + instance.getPort() + "/customer/";

		} else {
			url = "http://" + customerServiceHost + ":" + customerServicePort + "/customer/";
		}
